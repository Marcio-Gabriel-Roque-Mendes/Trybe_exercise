# O preço possui um caractere estranho Â£26.08 antes do seu valor.
# E a descrição do livro que contém o sufixo ...more.

# Seria conveniente, antes de estruturar e armazenar estes dados, que
# fizéssemos uma limpeza neles.

# No caso do valor, poderíamos utilizar uma expressão regular para remover os
# outros caracteres.
