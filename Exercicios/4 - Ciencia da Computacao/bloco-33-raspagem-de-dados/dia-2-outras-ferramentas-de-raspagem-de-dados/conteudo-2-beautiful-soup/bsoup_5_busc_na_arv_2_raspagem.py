# Para dar uma visão geral do que podemos utilizar e da simplicidade
# de fazer scraping com o Beautiful Soup, vamos fazer algo similar ao
# que fizemos no exemplo de Selenium e raspar as informações de
# uma página de notícias do site Tecmundo.
