# Existem ainda o leitor e o escritor baseados em dicionários.
# A principal vantagem é que não precisamos manipular os índices
# para acessar os dados das colunas. A desvantagem é o espaço ocupado
# em memória (que é maior que o comum), devido à estrutura de dados utilizada.
