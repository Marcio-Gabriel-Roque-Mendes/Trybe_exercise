...
var MailList = /** @class */ (function () {
    ...
    MailList.prototype.getByEmailsFrom = function (mailAdress) {
        return this.mailList.filter(function (mail) { return mail.from === mailAdress; });
    };
...
personalMailList.getByEmailsFrom(myEmail).forEach(function (mail) { return console.log(mail.content); });
