...
No código abaixo você tem a função getUser , que define um objeto 
com os dados de uma pessoa. Complete a função getUser de forma 
que ela receba uma função callback como parâmetro para realizar 
as operações abaixo:
...
const getUser = (usuarioComTempoEspera) => {
  setTimeout(() => {
    const user = {
      firstName: "Ivan",
      lastName: "Ivanovich",
    ...
    console.log(usuarioComTempoEspera(user));
  }, delay());
};
